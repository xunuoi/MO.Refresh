...
/**
 * For responseive util
 */

window.isScalable = true
...
!function(e, t) {
    ...
    if (c || (c = isScalable ? o.indexOf(s) > -1 ? s: 3: 1), t.dpr = c, t.scale = l = 1 / c, !n) {
        ...
        if (n = i.createElement("meta"), n.setAttribute("name", "viewport"), n.setAttribute("content", m + "initial-scale=" + l + ", maximum-scale=" + l + ", minimum-scale=" + l + ", user-scalable=no"), a.firstElementChild) a.firstElementChild.appendChild(n);
        else {
    ...
    t.changeScale = function(e, t) {
        if ("initial" != e) {
            if (!this.isScalable) return void(this.dpr = 1);
            var e = Math.floor(e) || s;
            this.dpr = o.indexOf(e) > -1 ? e: 3,
            this.scale = (1 / this.dpr).toFixed(2),
            this.scaleLock = t || !1;
            var i = "1.00" == this.scale ? "device-width": "";
            n.setAttribute("content", "width=" + i + ",initial-scale=" + this.scale + ", maximum-scale=" + this.scale + ", minimum-scale=" + this.scale + ", user-scalable=no")
        }
    ...
    function() {
        clearTimeout(d),
        t.scaleLock || window.isPGC || (d = setTimeout(t.changeScale, 300))
    },
    !1),
